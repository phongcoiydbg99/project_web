	...
	<div class="col-lg-4 mt-sm-5 mt-md-5 rounded p-3 mb-5 card container">
	   ...
	   //          echo $this->Form->error('username', $validator['username']['_empty']);}
				echo $this->Form->controls(
					['username' => ['class' => 'form-control is-invalid','required' => false,'placeholder' => 'Enter username', 'id' => 'username','label' => ['text'=>'Tên đăng nhập']],
										
					 'password' => ['class' => 'form-control is-invalid','required' => false,'placeholder' => 'Enter password', 'id' => 'password','label' => ['text'=>'Mật khẩu']]
					],['legend' => '']
				);

				echo $this->Form->button('Đăng nhập',['class' =>'btn btn-primary']);
